...
//function that displays the different possible number out scenarios with graphical exmaples
...
//function that displays the different possible number out scenarios
...
$this->monkey1['alignment'] = "bottom";//alignment attribute only used when creating graphical elements
}
else{
$nup1monkey =$nup1Bmonkey;
$nup1monkeyAmount = $nup1BmonkeyAmount;
$nup1monkeyFinal =$nup1BmonkeyFinal;	
$this->monkey1['alignment'] = "right";//alignment attribute only used when creating graphical elements
}
...
$this->monkey2['alignment'] = "right";//alignment attribute only used when creating graphical elements
...
$this->monkey2['alignment'] = "bottom";//alignment attribute only used when creating graphical elements
